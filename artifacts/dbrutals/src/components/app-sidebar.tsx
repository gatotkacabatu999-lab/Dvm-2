      ...
      <SidebarFooter>
        <SidebarMenu className="px-1 pt-1">
          <SidebarMenuItem className="rounded-lg border border-border/60">
            <DropdownMenu open={actionOpen} onOpenChange={setActionOpen}>
              ...
              <DropdownMenuContent
                className="w-(--radix-dropdown-menu-trigger-width) min-w-56 rounded-lg z-[70]"
                side="top"
                align="end"
                sideOffset={4}
              >
        ...
        <div className="flex items-center justify-center py-0">
          <button
            ...
            className="flex items-center justify-center rounded-xl p-0 hover:bg-sidebar-accent/40 transition-colors duration-150"
          >
            <img
              src={fmLogo}
              alt="FM logo"
